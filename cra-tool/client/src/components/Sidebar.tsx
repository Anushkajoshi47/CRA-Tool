...
const NAV = [
  { label: 'Dashboard',    path: '/cra/dashboard', Icon: GridIcon },
        ...
        <div className="sidebar-user">
          <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', padding: '12px' }}>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              <button onClick={logout} className="btn btn-ghost btn-sm" style={{ flex: 1, justifyContent: 'center', fontSize: '11.5px' }}>
                <LogoutIcon size={12} />
                Sign Out
              </button>
              <ThemeToggle />
